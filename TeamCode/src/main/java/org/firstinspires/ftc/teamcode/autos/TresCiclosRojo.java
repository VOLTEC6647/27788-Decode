...
public class TresCiclosRojo extends LinearOpMode {
    public static Pose start = new Pose(90, 135, Math.toRadians(90));
    public static Pose Shoot0 = new Pose(90, 95, Math.toRadians(125));

    public static Pose A0 = new Pose(90, 84, Math.toRadians(180));

    public static Pose I0 = new Pose(128, 84, Math.toRadians(180));

    public static Pose Shoot1 = new Pose(90, 95, Math.toRadians(125));

    public static Pose A1 = new Pose(90, 60, Math.toRadians(180));

    public static Pose I1 = new Pose(128, 60, Math.toRadians(180));

    public static Pose Shoot2 = new Pose(90, 95, Math.toRadians(125));
    public static Pose A2 = new Pose(90, 36, Math.toRadians(180));
    public static Pose I2 = new Pose(135, 36, Math.toRadians(180));
    public static Pose Shoot3 = new Pose(90, 95, Math.toRadians(125));
    public static Pose A3 = new Pose(127, 35, Math.toRadians(270));
    public static Pose I3 = new Pose(127, 10, Math.toRadians(270));
